...
Domain A was developed and explicitly approved by the Project Owner during pre-authorization planning. This record formally adopts that approved baseline into the governed Phase 2 baseline. Formal adoption does not reopen or redo its decisions and introduces no new material decision. Domain B has **NOT begun**; B1 has **NOT begun**.
