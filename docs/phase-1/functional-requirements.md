...
- Governance/Authority requirements use the non-circular, scoped, minimal, auditable Governance Bootstrap semantics in Items 17–21. Provenance may explain Bootstrap establishment but cannot create Bootstrap Authority; Source/Artifact content and self-describing status cannot independently establish it.
- Source, currentness, provenance, and sufficiency requirements use the Applicable Source Universe, evidence-boundary, and Observed Source State semantics in Items 7–35. In particular, registration or an observed local Git label/state does not independently establish Source-universe adequacy, Authority, shared/remote/governing state, or currentness.
- Package, rendering, Consumer authorization, and audit requirements use Construction-State Coherence in Items 36–39: a logically sufficient package, correct rendering, and actual Consumer receipt remain distinct, and known material incoherence or incomplete delivery cannot be silently represented as unqualified Sufficient.
- Cross-Project, authorization, sensitive-information, and audit requirements use the bounded-traversal and non-disclosing limitation semantics in Items 40–46. Explainability never independently authorizes disclosure of protected metadata/provenance.
