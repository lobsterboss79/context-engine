...
- [x] 2.2 [VAL] Validate normal end-to-end construction from explicit Bootstrap through each pipeline boundary to a logical Context Package and all approved renderings; preserve the construction record and evidence of every material transition. **COMPLETE — authorized `FX-F1 v1` nominal execution is PASS against frozen `ER-F1 v1`; complete original and derived evidence is preserved in [`VE-F1-001`](../docs/phase-4/validation-evidence/VE-F1-001/validation-evidence-record.md). No additional fixture was executed.**
- [x] 2.3 [VAL] Validate multiple Sources and multiple represented-information items without Source observation becoming interpretation, representation becoming selection, or Source count becoming ASU adequacy. **COMPLETE — authorized `FX-F2 v1` execution is PASS against frozen `ER-F2 v1`; complete original and derived evidence is preserved in [`VE-F2-001`](../docs/phase-4/validation-evidence/VE-F2-001/validation-evidence-record.md). This disposition completes Item 2.3 only; Item 2.4 remains incomplete.**
- [x] 2.4 [VAL] Validate competing Candidate Context, applicable versus non-applicable context, and Required versus Supporting determinations; preserve the reasons/evidence for inclusion, exclusion, and qualification. **COMPLETE — authorized `FX-F3 v1` execution is PASS against frozen `ER-F3 v1`; complete original and derived evidence is preserved in [`VE-F3-001`](../docs/phase-4/validation-evidence/VE-F3-001/validation-evidence-record.md). The bounded combined `VE-F2-001` + `VE-F3-001` review satisfies Item 2.4. No additional fixture was executed.**
- [ ] 2.5 [VAL] Validate sufficient, insufficient, and Conditional Sufficiency outcomes. Confirm that Required Context and ASU adequacy participate, Consumer capacity cannot waive Required Context, and Conditional Sufficiency does not conceal a Required deficiency. **IN PROGRESS — `VE-F4-A-001` and `VE-F4-B-001` preserve the authorized Required-available Sufficient and Required-unavailable Insufficient controls. Positive Conditional Sufficiency coverage remains outstanding; this item is not complete.**
